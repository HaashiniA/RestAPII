...
public class HaashiniChildren {
    ...
    public HaashiniChildren() {
    }
    public HaashiniChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
            String address) {
        this.babyId = babyId;
