...
public class HaashiniVillage {
    ...
    public HaashiniVillage(){}
    public HaashiniVillage(int villageId, String villageName, int numOfMen, int numOfWomen, int villagePopulation,
            int numOfSchools) {
