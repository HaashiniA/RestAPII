...
public class HaashiniMedicine {
    ...
    public HaashiniMedicine() {
    }
    public HaashiniMedicine(int medicineId, String medicineName, String medicineFor, String medicineBrand,
